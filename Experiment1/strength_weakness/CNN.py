...
def main():
    ...
    output_filename = '../../../Datasets/predict_result_new/strength_weakness/CNN.jsonl'

    model_path = 'TextCNN_strength_weakness_best_model.pth'
    ...
    # 3. 提取特征
    print("Preparing data (Extracting Strengths and Weaknesses)...") # 更新了打印信息
    ...
    best_val_acc = train_model(model, train_loader, val_loader, model_path, num_epochs=8, lr=0.0001)
