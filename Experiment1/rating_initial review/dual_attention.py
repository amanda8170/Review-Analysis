...
class PaperDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ### MODIFICATION: 调用新的函数提取所有审稿人的初始评论全文 ###
        combined_review_text = extract_earliest_reviewer_content(paper.get('reviews', []))
...
def main():
    ...
    OUTPUT_DIR = '../../../Datasets/predict_result_new/rating_initial review/'
