...
def main():
    ...
    input_filename = '../../Datasets/raw_dataset/ICLR.cc_2021.jsonl'
        # 只需要一个输出文件名
    output_filename = '../../Datasets/formatted_dataset/ICLR.cc_2021_formatted.jsonl'
